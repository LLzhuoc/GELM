...
class Blip2Base(BaseModel):
    ...
    def init_unimol_encoder(cls, args):
        ...
        dictionary = Dictionary.load('/home/cz/consel/MolTC-main/data_provider/unimol_dict.txt')
    ...
    def init_graph_encoder(
        cls, gin_num_layers, gin_hidden_dim, gin_drop_ratio,zijiegou=False,query_token=8,autozijiegou=False):
        graph_encoder = GNN(
