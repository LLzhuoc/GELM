...
class Blip2Stage2(pl.LightningModule):
    ...
    def save_predictions_valid(self, predictions, targets):
        ...
        with open(os.path.join('/home/cz/consel/MolTC-main/test_result/', f'test_{self.current_epoch}_{self.args.num_query_token}.txt'), 'w', encoding='utf8') as f:
    ...
    def save_predictions_valid_autozijiegou(self, predictions, targets, mlppredicts):
        ...
        print(len(predictions))
        print("----------------")
        with open(os.path.join('/data/cz/moltc/results/', 'newtest.txt'), 'w', encoding='utf8') as f:
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx):
        if self.args.DDI == True or self.args.double == True :
            ...
            if (self.current_epoch+1) % self.caption_eval_epoch != 0:
                return 
            graphs1,graphs2, prompt_tokens, texts,_ = batch
            ###============== Captioning Results ===================###
