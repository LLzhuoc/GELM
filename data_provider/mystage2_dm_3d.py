...
from data_provider.molecule_caption_dataset3d import MoleculeCaption, MoleculeCaption_double,MoleculeCaption_double_value,MoleculeCaption_double_DDIvalue,MoleculeCaption_double_fgtvalue,MoleculeCaption_universal,MoleculeCaption_double_consel
import re
...
class TrainCollater_double:
    ...
    def __call__(self, batch):
        graphs1,graphs2, texts ,smiles_prompt,y= zip(*batch)
        ...
        return graph_batch1,graph_batch2,smiles_prompt_tokens,text_tokens,y
...
class InferenceCollater_double:
    ...
    def __call__(self, batch):
        ...
        return graph_batch1,graph_batch2, smiles_prompt_tokens, texts ,y      
...
class Stage2DM_double(LightningDataModule):
    def __init__(
        ...
        if self.mode == 'testsel':
            self.train_dataset =  MoleculeCaption_double_consel(root, text_max_len,self.dictionary, self.prompt,False,True,self.args.solve)
        else:
