...
def main(args):
    ...
    #                                      save_last=True, 
    #                                      save_top_k=-1))
    callbacks.append(plc.ModelCheckpoint(dirpath="/home/cz/consel/MolTC-main/"+args.filename+"/", 
                                        filename='{epoch:02d}', 
                                        every_n_epochs=args.save_every_n_epochs, 
                                        save_last=True, 
                                        save_top_k=-1))
    if len(args.devices.split(',')) > 1:
        ...
        # args.device = "1"
    logger = CSVLogger(save_dir=f'/data/cz/moltc/all_checkpoints/{args.filename}/')
